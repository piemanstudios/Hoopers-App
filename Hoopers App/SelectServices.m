...
- (id)initWithStyle:(UITableViewStyle)style // withArray:(NSArray *)array
{
    ...
    if (self) {
        ...
        Service = [[NSArray alloc] initWithArray:[self getAllServices]];
    }
    return self;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    cell.textLabel.text = [Service objectAtIndex:indexPath. row];
    return cell;
}
...
{
    [self.delegate SelectServiceScreen:self didSelectService:[Service objectAtIndex:indexPath. row]];
